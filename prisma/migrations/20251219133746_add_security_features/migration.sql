/*
  ...
  - A unique constraint covering the columns `[appleOriginalTransactionId]` on the table `subscriptions` will be added. If there are existing duplicate values, this will fail.
  - A unique constraint covering the columns `[googlePurchaseToken]` on the table `subscriptions` will be added. If there are existing duplicate values, this will fail.
...
-- CreateEnum
CREATE TYPE "PlaylistType" AS ENUM ('CUSTOM', 'SYSTEM', 'CURATED', 'GENERATED', 'COURSE');

-- CreateEnum
CREATE TYPE "PlaylistContentType" AS ENUM ('MEDITATION', 'BREATHWORK', 'SOUNDSCAPE', 'SLEEP', 'MIXED');

-- CreateEnum
CREATE TYPE "PlaylistItemType" AS ENUM ('MEDITATION', 'BREATHWORK', 'SOUNDSCAPE', 'SLEEP_STORY');
...
ALTER TYPE "PaymentProvider" ADD VALUE 'GOOGLE';
...
-- DropIndex
DROP INDEX "subscriptions_userId_provider_key";

-- AlterTable
ALTER TABLE "challenges" ADD COLUMN     "badgeId" TEXT,
ADD COLUMN     "categories" TEXT[],
ADD COLUMN     "dailyGoalMinutes" INTEGER NOT NULL DEFAULT 15,
ADD COLUMN     "dailyGoalType" "ChallengeGoalType" NOT NULL DEFAULT 'DURATION',
...
ADD COLUMN     "coInstructorIds" TEXT[],
...
ADD COLUMN     "thumbnailUrl" TEXT,
ADD COLUMN     "totalRating" DOUBLE PRECISION NOT NULL DEFAULT 0,
ADD COLUMN     "videoDuration" INTEGER,
ADD COLUMN     "videoFileSize" BIGINT,
ADD COLUMN     "videoFormat" "VideoFormat",
ADD COLUMN     "videoId" TEXT,
ADD COLUMN     "videoQuality" "VideoQuality",
...
-- AlterTable
ALTER TABLE "programs" ADD COLUMN     "accessType" "ProgramAccessType" NOT NULL DEFAULT 'FREE',
...
CREATE TABLE "playlists" (
    ...
    "contentType" "PlaylistContentType" NOT NULL DEFAULT 'MIXED',
    "isSystem" BOOLEAN NOT NULL DEFAULT false,
    "isPublic" BOOLEAN NOT NULL DEFAULT false,
    "isFeatured" BOOLEAN NOT NULL DEFAULT false,
    "isPublished" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "playlist_items" (
    ...
    "contentType" "PlaylistItemType" NOT NULL,
    "meditationId" TEXT,
    "breathworkId" TEXT,
    "soundscapeId" TEXT,
    "sleepStoryId" TEXT,
...
-- CreateTable
CREATE TABLE "user_wellness_stats" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "totalMeditationMinutes" INTEGER NOT NULL DEFAULT 0,
    "totalMeditationCount" INTEGER NOT NULL DEFAULT 0,
    "totalBreathworkMinutes" INTEGER NOT NULL DEFAULT 0,
    "totalBreathworkCount" INTEGER NOT NULL DEFAULT 0,
    "totalSessionMinutes" INTEGER NOT NULL DEFAULT 0,
    "totalSessionCount" INTEGER NOT NULL DEFAULT 0,
    "totalSleepStoryCount" INTEGER NOT NULL DEFAULT 0,
    ...
    "weeklySessionCount" INTEGER NOT NULL DEFAULT 0,
    ...
    CONSTRAINT "user_wellness_stats_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "goal_templates_type_idx" ON "goal_templates"("type");

-- CreateIndex
CREATE INDEX "goal_templates_isActive_idx" ON "goal_templates"("isActive");

-- CreateIndex
CREATE INDEX "reminder_templates_type_idx" ON "reminder_templates"("type");

-- CreateIndex
CREATE INDEX "reminder_templates_isActive_idx" ON "reminder_templates"("isActive");
...
-- CreateIndex
CREATE INDEX "playlist_items_meditationId_idx" ON "playlist_items"("meditationId");

-- CreateIndex
CREATE INDEX "playlist_items_breathworkId_idx" ON "playlist_items"("breathworkId");

-- CreateIndex
CREATE INDEX "playlist_items_soundscapeId_idx" ON "playlist_items"("soundscapeId");

-- CreateIndex
CREATE INDEX "playlist_items_sleepStoryId_idx" ON "playlist_items"("sleepStoryId");

-- CreateIndex
CREATE INDEX "saved_playlists_userId_idx" ON "saved_playlists"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "saved_playlists_userId_playlistId_key" ON "saved_playlists"("userId", "playlistId");

-- CreateIndex
CREATE UNIQUE INDEX "user_wellness_stats_userId_key" ON "user_wellness_stats"("userId");
...
-- AddForeignKey
ALTER TABLE "playlist_items" ADD CONSTRAINT "playlist_items_meditationId_fkey" FOREIGN KEY ("meditationId") REFERENCES "meditations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "playlist_items" ADD CONSTRAINT "playlist_items_breathworkId_fkey" FOREIGN KEY ("breathworkId") REFERENCES "breathworks"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "playlist_items" ADD CONSTRAINT "playlist_items_soundscapeId_fkey" FOREIGN KEY ("soundscapeId") REFERENCES "soundscapes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "playlist_items" ADD CONSTRAINT "playlist_items_sleepStoryId_fkey" FOREIGN KEY ("sleepStoryId") REFERENCES "sleep_stories"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "saved_playlists" ADD CONSTRAINT "saved_playlists_playlistId_fkey" FOREIGN KEY ("playlistId") REFERENCES "playlists"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_wellness_stats" ADD CONSTRAINT "user_wellness_stats_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
