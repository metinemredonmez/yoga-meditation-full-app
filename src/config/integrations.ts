...
> = {
  ...
  payment: {
    ...
    google_pay_web: {
      name: 'Google Pay (Web)',
      icon: '💳',
      description: 'Web sitesinde Google Pay ile ödeme alma',
      ...
      fields: [
        {
          ...
          type: 'text',
          required: true,
          placeholder: 'BCR2DN4T7MBIPMQV',
          description: 'Google Pay Business Console\'dan alınan Merchant ID',
        },
        {
          key: 'merchant_name',
          label: 'Merchant Name',
          ...
          required: true,
          placeholder: 'Yoga App',
          description: 'Müşterilere gösterilecek işletme adı',
        },
        {
          key: 'environment',
          label: 'Environment',
          type: 'text',
          required: true,
          placeholder: 'TEST veya PRODUCTION',
          description: 'TEST (sandbox) veya PRODUCTION',
        },
        {
          key: 'gateway',
          ...
          required: true,
          placeholder: 'stripe',
          description: 'Kullanılan ödeme sağlayıcısı (stripe, iyzico, vb.)',
        },
        {
          ...
          type: 'text',
          required: false,
          description: 'Ödeme sağlayıcısındaki merchant ID (Stripe için gerekli değil)',
        },
        {
          key: 'allowed_card_networks',
          label: 'Allowed Card Networks',
          type: 'text',
          required: false,
          placeholder: 'VISA,MASTERCARD,AMEX',
          description: 'Kabul edilen kart ağları (virgülle ayrılmış)',
        },
        {
          key: 'is_enabled',
          label: 'Aktif',
          ...
          description: 'Google Pay ödemelerini aktif et/kapat',
        },
      ],
    },
    apple_pay_web: {
      name: 'Apple Pay (Web)',
      icon: '🍎',
      description: 'Web sitesinde Apple Pay ile ödeme alma',
      ...
      fields: [
        {
          ...
          description: 'Apple Developer\'dan alınan Merchant Identifier',
        },
        {
          key: 'merchant_name',
          label: 'Merchant Name',
        ...
        },
        {
          ...
          type: 'text',
          required: true,
          placeholder: 'yogaapp.com',
          description: 'Apple Pay\'in aktif olacağı domain',
        },
        {
          key: 'merchant_identity_certificate',
          label: 'Merchant Identity Certificate',
          type: 'textarea',
          required: true,
          description: 'Apple Developer\'dan indirilen .pem sertifikası',
        },
        {
          key: 'merchant_identity_key',
          label: 'Merchant Identity Private Key',
          type: 'textarea',
          required: true,
          description: 'Sertifika için private key (.key)',
        },
        {
          key: 'payment_processing_certificate',
          label: 'Payment Processing Certificate',
          type: 'textarea',
          required: false,
          description: 'Ödeme işleme sertifikası (opsiyonel)',
        },
        {
          ...
          required: false,
          placeholder: 'visa,masterCard,amex',
          description: 'Desteklenen kart ağları (virgülle ayrılmış)',
        },
        {
          key: 'is_enabled',
          label: 'Aktif',
          ...
          required: true,
          placeholder: 'true veya false',
          description: 'Apple Pay ödemelerini aktif et/kapat',
        },
      ],
    },
  },
