...
export function StudentSidebar() {
  ...
  const userInitials = user?.firstName && user?.lastName
    ...
    : user?.email ? user.email.substring(0, 2).toUpperCase() : 'KU';
            ...
            <SidebarMenuButton size='lg' asChild>
              <Link href='/student'>
                ...
                <div className='flex flex-col gap-0.5 leading-none'>
                  <span className='font-semibold'>Yoga Platform</span>
                  <span className='text-xs text-muted-foreground'>Hoş Geldiniz</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <div className='grid flex-1 text-left text-sm leading-tight'>
                    ...
                    <span className='truncate text-xs text-muted-foreground'>Kullanıcı</span>
                  </div>
              ...
              >
                ...
                <DropdownMenuGroup>
                  ...
                  <DropdownMenuItem onClick={() => router.push('/student/notifications')}>
